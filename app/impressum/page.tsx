  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 text-secondary">
      ...
      <div className="space-y-8">
        ...
        <section>
          <h2 className="font-display text-2xl text-accent mb-4 uppercase">Angaben gemäß § 5 TMG</h2>
          <p className="leading-relaxed">
            <strong>The Croax</strong><br />
            c/o [Vorname Nachname des Verantwortlichen]<br />
            [Musterstraße 1]<br />
            [20xxx Hamburg]
          </p>
        </section>
        ...
        {/* SECTION 2: Contact */}
        <section>
          <h2 className="font-display text-2xl text-accent mb-4 uppercase">Kontakt</h2>
          <p className="leading-relaxed">
            Telefon: [Deine Telefonnummer]<br />
            E-Mail: <a href="mailto:band@thecroax.com" className="hover:text-white underline">band@thecroax.com</a>
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm text-gray-400 mb-2">gem. § 55 Abs. 2 RStV / § 18 Abs. 2 MStV:</p>
          <p className="leading-relaxed">
            [Vorname Nachname]<br />
            [Musterstraße 1]<br />
            [20xxx Hamburg]
        ...
        <section className="mt-8 pt-8 border-t border-lightGray text-sm text-gray-400">
          ...
          <p>
            ...
            <a href="https://ec.europa.eu/consumers/odr/" target="_blank" rel="noopener noreferrer" className="hover:text-white underline ml-1">
